...
//        purseAllPagesMultiThread(executor).forEach(System.out::println);
    ...
    public List<CpuHotLine> purseAllPagesMultiThread(ExecutorService executor) {
        ...
        for (int i = startPage; i <= maxPage; i++) {
            ...
            Future<List<CpuHotLine>> future = executor.submit(() -> {
                List<CpuHotLine> purse = pursePage(BASE_URL + pageIndex, true);
    ...
    public List<CpuHotLine> purseAllPages() {
        ...
        for (int i = startPage; i <= maxPage; i++) {
            final List<CpuHotLine> purse = pursePage(BASE_URL + i,true);
            parts.addAll(purse);
    ...
    public List<CpuHotLine> pursePage(String url,boolean useDelay) {
