...
public class HotlineMatherBoardPageParserImpl
...
//    @PostConstruct
//    public void init() {
//        List<MotherBoardHotLIne> cpuHotLines = parsePage(
//                BASE_URL + 19,
//                true,
//                true,
//                3,
...
//
//    @Override
//    public List<MotherBoardHotLIne> parseAllPagesMultiThread(ExecutorService executor) {
////        int startPage = 1;
...
//    }
//
//    public List<MotherBoardHotLIne> parsePage(
//            String url,
...
//        } else {
//            for (Element motherboardBlock : tableElements) {
//                MotherBoardHotLIne motherboard = new MotherBoardHotLIne();
//                motherboard.setUrl(DOMAIN_LINK + parseUrl(motherboardBlock));
//                motherboard.setName(parseName(motherboardBlock));
//                motherboard.setPrices(parsePrices(motherboardBlock));
//
//                Element characteristicsBlock = motherboardBlock.select("div.specs__text").first();
//                parseDataFromCharacteristicsBlock(characteristicsBlock, motherboard);
//
